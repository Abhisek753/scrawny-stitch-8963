...
import {Grid,Avatar, Box,Container,Flex,Spacer,Text,Wrap,WrapItemm,Stack ,Select,WrapItem,Option,Input,Button,  Menu,
  MenuButton,
  MenuList,
  MenuItem,
  MenuItemOption,
...
>
  ...
  <GridItem colSpan={1}  ><MenuDivider /> <Text as='b' >Jobs</Text><MenuDivider />
...
<MenuItem>Hard Disk&Monitor </MenuItem>
  ...
  <GridItem colSpan={1} bg='tomato' > <MenuDivider /><Text as='b' >Fashion</Text>
  ...
  <MenuDivider/>
   ...
   <Text as='b' m="auto"     _hover={{ bg: 'gray.400' }}  mt="10px" >rent(house&appartment)</Text>
